#!/usr/bin/env python3
"""Generate Smart Recipe Book's mod menu icon: the vanilla knowledge book.
...
OUT = os.path.join(HERE, "src/main/resources/assets/smart-recipe-book/icon.png")
...
def build_icon():
    """The mod ships no textures of its own. The knowledge book is the game's
    own recipe book item, which is exactly what this mod replaces."""
    return scale(vanilla("item/knowledge_book.png"), 8)
