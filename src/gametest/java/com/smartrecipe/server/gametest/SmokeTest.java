package com.smartrecipe.server.gametest;
...
public final class SmokeTest implements FabricClientGameTest {
	...
	public void runTest(ClientGameTestContext context) {
		if (!FabricLoader.getInstance().isModLoaded("smart-recipe-book")) {
			throw new AssertionError("smart-recipe-book is not loaded: the test is testing nothing");
		}
